...
export const getClearIconSize = (size: string) => {
  switch (size) {
    case SIZE.compact: {
      return 'scale600';
    }
...
export const ClearContainer = styled('div', ({$size, $isTextarea, $theme}) => {
  const sidePadding =
    $size === SIZE.compact
  ...
  return {
    ...
    paddingTop: $isTextarea ? sidePadding : '0px',
  };
});

export const ClearIcon = styled(DeleteAlt, {
  cursor: 'pointer',
});
